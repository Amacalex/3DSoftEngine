...
namespace _2DGameEngine
{
    ...
    struct OrientedRectangle2 : IShape, I2DPoint, ISolid
    {
        ...
        { this.center = center; this.halfExtend = halfExtend; this.rotation = rotation; id = ""; }
        public Vector2 Center { get => center; set => center = value; }
    ...
    class Triangle : IShape, I3DPoint, ISolid
    {
        Vector3 pos;
        Vector3 rotation;
        Vector2 scale;
